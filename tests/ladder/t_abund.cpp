...
TEST_CASE("LAbund_Test")
{
    ...
    REQUIRE(r.measure.count("C_16_A") == 1);
    REQUIRE(r.measure.count("C_16_B") == 1);
    REQUIRE(r.measure.count("C_16_C") == 1);
    REQUIRE(r.measure.count("C_16_D") == 1);
    ...
    REQUIRE(r.measure.at("C_16_A") == 66);
    REQUIRE(r.measure.at("C_16_B") == 113);
    REQUIRE(r.measure.at("C_16_C") == 239);
    REQUIRE(r.measure.at("C_16_D") == 416);
