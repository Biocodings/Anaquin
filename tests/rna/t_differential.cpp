...
{
//    const auto r = Differential::analyze("tests/data/rna_sims/diffs/gene_exp.diff");
}
...
//    const auto r = Differential::analyze("tests/data/rna_sims/diffs/isoform_exp.diff", o);
}