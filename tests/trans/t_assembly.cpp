...
TEST_CASE("TAssembly_T_1000")
{
    ...
    const auto r1 = Test::test("-t TransAssembly -m data/trans/TransMixture_4.1.csv -rgtf data/trans/TransStandard_1.0.gtf -ugtf tests/data/T_1000/A/G/transcripts.gtf");
