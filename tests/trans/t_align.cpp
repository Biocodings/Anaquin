...
TEST_CASE("TAlign_T_1000_First_100")
{
    ...
    const auto r1 = Test::test("-t TransAlign -m data/trans/MTR002.v013.csv -rgtf data/trans/TransStandard_1.0.gtf -usam tests/data/T_1000/B/accepted_hits_1000.sam");
