...
TEST_CASE("Test_Junction")
{
    ...
    REQUIRE(aligns[0].l.start == 528084);
    REQUIRE(aligns[0].l.end == 528162);
    REQUIRE(aligns[0].l.length() == 79);

    REQUIRE(aligns[1].spliced);
    REQUIRE(aligns[1].l.start == 528163);
    REQUIRE(aligns[1].l.end == 538412);
    REQUIRE(aligns[1].l.length() == 10250);

    REQUIRE(!aligns[2].spliced);
    REQUIRE(aligns[2].l.start == 538413);
    REQUIRE(aligns[2].l.end == 538434);
