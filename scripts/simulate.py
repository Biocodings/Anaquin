...
def dna_path():
    return '/home/tedwon/Projects/DNA_Simulation/'

def rna_path():
    return '/home/tedwon/Projects/RNA_Simulation/'
...
if __name__ == '__main__':
    if (len(sys.argv) != 2):
        ...
        simulate_reads(d_standards(), dna_seq_path(), dna_read_path(), 100000, 100000)
    elif (sys.argv[1] == 'DNA'):
        split_sequins(d_sequins(), dna_seq_path())
