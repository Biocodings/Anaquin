...
cat RNA_A_1_2/assembly/transcripts.gtf  >> assemblies.txt
cat RNA_A_1_3/assembly/transcripts.gtf  >> assemblies.txt
cat RNA_B_20_1/assembly/transcripts.gtf >> assemblies.txt
cat RNA_B_20_2/assembly/transcripts.gtf >> assemblies.txt
cat RNA_B_20_3/assembly/transcripts.gtf >> assemblies.txt
