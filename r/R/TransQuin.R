...
#
# Convert the name of a synthetic isofrom to it's gene name
#
#   Eg: R1_1 for R1_1_1 and R1_1_2    

sequinToGenes <- function(name)
{
    trans <- as.character(name)
    genes <- substr(as.character(name), 1, nchar(name)-2)
    genes
}
