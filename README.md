...
Anaquin is a C++/R bioinformatics framework for sequins which provide qualitative and quantitative control for next-generation sequencing. The following fields are supported:
