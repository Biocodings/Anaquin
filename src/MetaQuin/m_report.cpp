...
//
//MReport::Stats MReport::analyze(const FileName &data, const Options &o)
//{
...
//}
//
//void MReport::report(const FileName &file, const Options &o)
//{
//    const auto stats = MReport::analyze(file, o);
//    
