...
void FFusion::report(const FileName &file, const Options &o)
{
    ...
    /*
     * Generating FusFusion_summary.stats
     */
    ...
    o.info("Generating FusFusion_sequins.csv");
    o.writer->open("FusFusion_sequins.csv");
    o.writer->write(StatsWriter::writeCSV(stats));
    o.writer->close();
    
    /*
     * Generating FusFusion_express.R
     */
    
    o.info("Generating FusFusion_express.R");
    o.writer->open("FusFusion_express.R");
    o.writer->write(RWriter::createScript("FusFusion_sequins.csv", PlotFFusion()));
    o.writer->close();
}