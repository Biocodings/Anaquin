...
static FILE* ffasta=NULL;
static FILE* f_in=NULL;
static FILE* f_out=NULL;
static FILE* f_w=NULL; //fasta with spliced exons (transcripts)
static FILE* f_x=NULL; //fasta with spliced CDS
static FILE* f_y=NULL; //fasta with translated CDS
bool wCDSonly=false;
